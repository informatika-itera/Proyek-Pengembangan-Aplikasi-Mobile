...
-keep,includedescriptorclasses class com.example.movein.**$$serializer { *; }
-keepclassmembers class com.example.movein.** {
    *** Companion;
}
-keepclasseswithmembers class com.example.movein.** {
    kotlinx.serialization.KSerializer serializer(...);
}
...
-keep class com.example.movein.data.local.** { *; }

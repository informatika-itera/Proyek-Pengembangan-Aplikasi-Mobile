...
-keep,includedescriptorclasses class com.example.fitkos.**$$serializer { *; }
-keepclassmembers class com.example.fitkos.** {
    *** Companion;
}
-keepclasseswithmembers class com.example.fitkos.** {
    kotlinx.serialization.KSerializer serializer(...);
}
...
-keep class com.example.fitkos.data.local.** { *; }

...
-keep,includedescriptorclasses class com.example.tabungin.**$$serializer { *; }
-keepclassmembers class com.example.tabungin.** {
    *** Companion;
}
-keepclasseswithmembers class com.example.tabungin.** {
    kotlinx.serialization.KSerializer serializer(...);
}
...
-keep class com.example.tabungin.data.local.** { *; }

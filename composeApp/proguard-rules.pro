...
-keep,includedescriptorclasses class com.example.neurodeck.**$$serializer { *; }
-keepclassmembers class com.example.neurodeck.** {
    *** Companion;
}
-keepclasseswithmembers class com.example.neurodeck.** {
    kotlinx.serialization.KSerializer serializer(...);
}
...
-keep class com.example.neurodeck.data.local.** { *; }

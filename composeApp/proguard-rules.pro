...
-keep,includedescriptorclasses class com.example.raillog.**$$serializer { *; }
-keepclassmembers class com.example.raillog.** {
    *** Companion;
}
-keepclasseswithmembers class com.example.raillog.** {
    kotlinx.serialization.KSerializer serializer(...);
}
...
-keep class com.example.raillog.data.local.** { *; }

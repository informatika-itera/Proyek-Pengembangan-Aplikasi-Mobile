...
-keep,includedescriptorclasses class com.example.metaforge.**$$serializer { *; }
-keepclassmembers class com.example.metaforge.** {
    *** Companion;
}
-keepclasseswithmembers class com.example.metaforge.** {
    kotlinx.serialization.KSerializer serializer(...);
}
...
-keep class com.example.metaforge.data.local.** { *; }

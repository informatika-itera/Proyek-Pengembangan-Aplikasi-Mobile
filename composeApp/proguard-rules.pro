...
-keep,includedescriptorclasses class com.example.pocketguard.**$$serializer { *; }
-keepclassmembers class com.example.pocketguard.** {
    *** Companion;
}
-keepclasseswithmembers class com.example.pocketguard.** {
    kotlinx.serialization.KSerializer serializer(...);
}
...
-keep class com.example.pocketguard.data.local.** { *; }

...
-keep,includedescriptorclasses class com.example.nutriscan.**$$serializer { *; }
-keepclassmembers class com.example.nutriscan.** {
    *** Companion;
}
-keepclasseswithmembers class com.example.nutriscan.** {
    kotlinx.serialization.KSerializer serializer(...);
}
...
-keep class com.example.nutriscan.data.local.** { *; }

...
-keep,includedescriptorclasses class com.example.todomaster.**$$serializer { *; }
-keepclassmembers class com.example.todomaster.** {
    *** Companion;
}
-keepclasseswithmembers class com.example.todomaster.** {
    kotlinx.serialization.KSerializer serializer(...);
}
...
-keep class com.example.todomaster.data.local.** { *; }

...
-keep,includedescriptorclasses class com.example.sholatyuk.**$$serializer { *; }
-keepclassmembers class com.example.sholatyuk.** {
    *** Companion;
}
-keepclasseswithmembers class com.example.sholatyuk.** {
    kotlinx.serialization.KSerializer serializer(...);
}
...
-keep class com.example.sholatyuk.data.local.** { *; }

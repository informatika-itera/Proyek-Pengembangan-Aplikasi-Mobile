...
-keep,includedescriptorclasses class com.example.bridgebit.**$$serializer { *; }
-keepclassmembers class com.example.bridgebit.** {
    *** Companion;
}
-keepclasseswithmembers class com.example.bridgebit.** {
    kotlinx.serialization.KSerializer serializer(...);
}
...
-keep class com.example.bridgebit.data.local.** { *; }

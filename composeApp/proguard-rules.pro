...
-keep,includedescriptorclasses class com.example.gamenews.**$$serializer { *; }
-keepclassmembers class com.example.gamenews.** {
    *** Companion;
}
-keepclasseswithmembers class com.example.gamenews.** {
    kotlinx.serialization.KSerializer serializer(...);
}
...
-keep class com.example.gamenews.data.local.** { *; }

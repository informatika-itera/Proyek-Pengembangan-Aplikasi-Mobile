...
-keep,includedescriptorclasses class com.example.tripmate.**$$serializer { *; }
-keepclassmembers class com.example.tripmate.** {
    *** Companion;
}
-keepclasseswithmembers class com.example.tripmate.** {
    kotlinx.serialization.KSerializer serializer(...);
}
...
-keep class com.example.tripmate.data.local.** { *; }

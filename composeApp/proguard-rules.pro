...
-keep,includedescriptorclasses class com.example.Feelia.**$$serializer { *; }
-keepclassmembers class com.example.Feelia.** {
    *** Companion;
}
-keepclasseswithmembers class com.example.Feelia.** {
    kotlinx.serialization.KSerializer serializer(...);
}
...
-keep class com.example.Feelia.data.local.** { *; }

...
-keep,includedescriptorclasses class com.example.inventra.**$$serializer { *; }
-keepclassmembers class com.example.inventra.** {
    *** Companion;
}
-keepclasseswithmembers class com.example.inventra.** {
    kotlinx.serialization.KSerializer serializer(...);
}
...
-keep class com.example.inventra.data.local.** { *; }

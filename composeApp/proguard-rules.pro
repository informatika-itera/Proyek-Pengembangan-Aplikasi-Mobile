...
-keep,includedescriptorclasses class com.kelazzz.app.**$$serializer { *; }
-keepclassmembers class com.kelazzz.app.** {
    *** Companion;
}
-keepclasseswithmembers class com.kelazzz.app.** {
    kotlinx.serialization.KSerializer serializer(...);
}
...
-keep class com.kelazzz.app.data.local.** { *; }

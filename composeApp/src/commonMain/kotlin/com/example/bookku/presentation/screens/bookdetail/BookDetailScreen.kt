        ...
        when (val state = uiState) {
            ...
            is NoteDetailUiState.Success -> {
                Column(
                    ...
                    if (state.book.title.isNotBlank()) {
                        Text(
                    ...
                    Row(
                        ...
                        CategoryBadge(category = state.book.category.displayName)
                        
                        Text(
                            text = state.book.updatedAt.formatToDisplay(),
            ...
            is NoteDetailUiState.NotFound -> {
                EmptyState(
                    ...
                    message = "Buku mungkin sudah dihapus"
                )
            }
        }
    }

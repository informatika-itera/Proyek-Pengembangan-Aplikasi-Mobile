...
import com.example.rewind.data.local.entity.toDomain
import com.example.rewind.data.local.entity.toDomainList
import com.example.rewind.data.local.entity.toEntityValues
...
class NoteRepositoryImpl(private val database: RewindDatabase) : NoteRepository {

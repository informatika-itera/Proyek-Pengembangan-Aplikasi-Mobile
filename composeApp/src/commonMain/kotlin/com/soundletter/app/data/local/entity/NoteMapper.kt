...
fun NoteEntity.toDomain(): Note {
    return Note(
        ...
        songTitle = this.song_title?.takeIf { it.isNotBlank() },
        songArtist = this.song_artist?.takeIf { it.isNotBlank() },
        songPreviewUrl = this.song_preview_url?.takeIf { it.isNotBlank() },
        songAlbumArtUrl = this.song_album_art_url?.takeIf { it.isNotBlank() },
...
fun Note.toEntityValues(): NoteEntity {
    return NoteEntity(
        ...
        song_preview_url = this.songPreviewUrl,
        song_album_art_url = this.songAlbumArtUrl,

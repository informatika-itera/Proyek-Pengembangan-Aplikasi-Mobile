...
git clone https://github.com/USERNAME_ANDA/Hujjah-KMP.git
...
git remote -v
# Output:
# origin  https://github.com/USERNAME_ANDA/Hujjah-KMP.git (fetch)
# origin  https://github.com/USERNAME_ANDA/Hujjah-KMP.git (push)
```
...
git remote add upstream https://github.com/DOSEN/Hujjah-KMP-Template.git
...
# origin    https://github.com/USERNAME_ANDA/Hujjah-KMP.git (fetch)
# origin    https://github.com/USERNAME_ANDA/Hujjah-KMP.git (push)
# upstream  https://github.com/DOSEN/Hujjah-KMP-Template.git (fetch)
# upstream  https://github.com/DOSEN/Hujjah-KMP-Template.git (push)
```

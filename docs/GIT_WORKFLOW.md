...
git clone https://github.com/USERNAME_ANDA/neurodeck-KMP.git
...
git remote -v
# Output:
# origin  https://github.com/USERNAME_ANDA/Neurodeck-KMP.git (fetch)
# origin  https://github.com/USERNAME_ANDA/Neurodeck-KMP.git (push)
```
...
git remote add upstream https://github.com/DOSEN/neurodeck-KMP-Template.git
...
# origin    https://github.com/USERNAME_ANDA/neurodeck-KMP.git (fetch)
# origin    https://github.com/USERNAME_ANDA/neurodeck-KMP.git (push)
# upstream  https://github.com/DOSEN/neurodeck-KMP-Template.git (fetch)
# upstream  https://github.com/DOSEN/neurodeck-KMP-Template.git (push)
```

...
composeApp/src/
│
├── commonMain/kotlin/com/kosthub/app/    # ← Shared code (95%+)
│   │
│   ├── core/                                 # Core utilities
...
│   └── com/kosthub/app/
│       └── Kost.sq                           # Database schema & queries
│
...
// Android
class KostHubApplication : Application() {
...
|------|------------|---------|
| Package | lowercase | `com.kosthub.app.domain` |
